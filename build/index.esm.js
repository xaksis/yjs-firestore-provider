import { getFirestore, doc as doc$1, setDoc, serverTimestamp, getDoc, deleteDoc, query as query$1, collection as collection$1, onSnapshot as onSnapshot$1, writeBatch, runTransaction, Bytes, getDocs } from '@firebase/firestore';
import * as Y from 'yjs';
import SimplePeer from 'simple-peer/simplepeer.min.js';
import * as awarenessProtocol from 'y-protocols/awareness';
import { getFirestore as getFirestore$1, collection, query, onSnapshot, doc as doc$2, deleteDoc as deleteDoc$1, serverTimestamp as serverTimestamp$1, getDoc as getDoc$1, Timestamp, setDoc as setDoc$1 } from 'firebase/firestore';
...
const readMessage = (room, buf, syncedCallback) => {
    ...
    switch (messageType) {
        ...
        case messageQueryAwareness:
            ...
            writeVarUint8Array(encoder, awarenessProtocol.encodeAwarenessUpdate(awareness, Array.from(awareness.getStates().keys())));
            sendReply = true;
            break;
        case messageAwareness:
            awarenessProtocol.applyAwarenessUpdate(awareness, readVarUint8Array(decoder), room);
            break;
...
class FirestoreWebrtcConn {
    constructor(signalingConn, initiator, remotePeerId, room) {
        ...
        this.synced = false;
        this.peer = new SimplePeer(Object.assign({ initiator }, room.provider.peerOpts));
        ...
        this.peer.on('connect', () => {
            ...
            if (awarenessStates.size > 0) {
                const encoder = createEncoder();
                writeVarUint(encoder, messageAwareness);
                writeVarUint8Array(encoder, awarenessProtocol.encodeAwarenessUpdate(awareness, Array.from(awarenessStates.keys())));
                sendWebrtcConn(this, encoder);
            }
        });
        this.peer.on('close', () => {
    ...
    handleUnresponsivePeer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (signalingConn) {
                ...
                const db = getFirestore$1(signalingConn.firebaseApp);
                const announceRef = doc$2(db, announcePath);
                const list = [
                    deleteDoc$1(announceRef)
                ];
                const signals = this.signals;
                if (signals) {
                    signals.forEach(msgId => {
                        const signalPath = getSignalPath(basePath, this.remotePeerId, msgId);
                        const signalRef = doc$2(db, signalPath);
                        list.push(deleteDoc$1(signalRef));
                    });
                }
...
class Room {
    constructor(doc, provider, name, key) {
        ...
        this._awarenessUpdateHandler = ({ added, updated, removed }, origin) => {
            ...
            writeVarUint8Array(encoderAwareness, awarenessProtocol.encodeAwarenessUpdate(this.awareness, changedClients));
    ...
    connect() {
        ...
        writeVarUint8Array(encoderAwarenessState, awarenessProtocol.encodeAwarenessUpdate(this.awareness, [this.doc.clientID]));
...
class FirestoreWebrtcProvider extends Observable {
    constructor(firebaseApp, roomName, doc, { password = null, awareness = new awarenessProtocol.Awareness(doc), maxConns = 20 + floor(rand() * 15), // the random factor reduces the chance that n clients form a cluster
...
class FirestoreSignalingConn {
    ...
    subscribeAnnounce() {
        ...
        const db = getFirestore$1(this.firebaseApp);
                ...
                switch (change.type) {
                    ...
                    case 'modified': {
                        ...
                        if (data) {
                            ...
                            yield deleteDoc$1(document.ref);
                        }
                        break;
                    }
                }
    ...
    publishAnnounce() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const room = this.room;
            const data = { from: room.peerId, createdAt: serverTimestamp$1() };
            ...
            if (announceRef) {
                ...
                const announceDoc = yield getDoc$1(announceRef);
    ...
    deleteAnnounceDoc() {
        return __awaiter(this, void 0, void 0, function* () {
            const announcePath = this.getAnnouncePath();
            const db = getFirestore$1(this.firebaseApp);
            const ref = doc$2(db, announcePath);
            yield deleteDoc$1(ref);
        });
    }
    encodeData(data) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    save(path, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const db = getFirestore$1(this.firebaseApp);
                const ref = doc$2(db, path);
                yield setDoc$1(ref, envelope);
                return ref;
            }
            catch (error) {
...
function getUpdates(db, path) {
    return __awaiter(this, void 0, void 0, function* () {
        const set = new Set();
        const ref = collection$1(db, path);
...
function deleteYjsData(firebaseApp, path, updateSet) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const shutdownRef = doc$1(db, shutdownPath);
        yield setDoc(shutdownRef, {});
        const baselineRef = doc$1(db, basePath + YJS_HISTORY);
...
class FirestoreProvider extends Observable {
    constructor(firebaseApp, ydoc, path, eventHandlers, config) {
        ...
        const q = query$1(collection$1(db, collectionPath));
        const baselinePath = this.basePath + YJS_HISTORY;
        const baseRef = doc$1(db, baselinePath);
        ...
        getDoc(baseRef)
            ...
            self.unsubscribe = onSnapshot$1(q, (snapshot) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield runTransaction(db, (txn) => __awaiter(this, void 0, void 0, function* () {
                    const baselineRef = doc$1(db, baselinePath);
                    ...
                    for (const key of zombies) {
                        const ref = doc$1(db, updatesPath, key);
                        txn.delete(ref);
                    }
                }));
            }
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (update && !this.isStopped) {
                ...
                const docRef = doc$1(db, path, updateId);
                const fullDocRef = doc$1(db, this.basePath);
...
export { FirestoreProvider, deleteYjsData, getColor };
